...
<p align="center">
  <img src="https://github.com/Dr-RAYLI/LisKerasNN/blob/master/pics/NNTraining.gif">
</p>
...
###################### RUN FUNCTION: LisKerasNN #######################

# We want to store everything in an object:
# Let us call this **Result**
Begin.Time <- Sys.time()
Result <- LisKerasNN::LisKerasNN(x, y, cutoff = 0.8)
...
# Let us call this **Result**
Begin.Time <- Sys.time()
Result <- LisKerasNN::LisKerasNN(x = all[,-1], y = all[, 1], cutoff = 0.8)
End.Time <- Sys.time(); print(paste0("Time spent on training this machine: ", End.Time - Begin.Time))
...
* [Keras R Interface](https://keras.rstudio.com/): I used this site as code source for Keras R interface. 
